...
session_start();
include "koneksi.php";
$id_prodi = isset($_GET['id_prodi']) ? $_GET['id_prodi'] : '';$query = mysqli_query($koneksi, "SELECT * FROM prodi WHERE id_prodi='$id_prodi'");
...
<form method="POST">
    ...
    <input type="text" name="kd_prodi" value="<?php echo $data['kd_prodi']; ?>"
required>
